...
const csp = [
  ...
  `connect-src 'self' https://*.mozu.com https://*.kibocommerce.com https://cdn.builder.io https://*.builder.io https://www.google.com https://www.google.co.in https://analytics.google.com https://*.googletagmanager.com https://*.google-analytics.com https://*.analytics.google.com https://*.algolia.net https://*.algolianet.com https://go.bethyl.com https://www.fortislife.com https://insights.algolia.io https://api-prod.secureprivacy.ai https://*.secureprivacy.ai https://track.hubspot.com https://*.hsforms.com https://forms.hscollectedforms.net https://*.clarity.ms https://*.snitcher.com https://*.hubspotusercontent-na1.net https://*.hotjar.com https://*.hotjar.in https://vc.hotjar.io 'wss://ws.hotjar.com https://content.hotjar.io/`,
